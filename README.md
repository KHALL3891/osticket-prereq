...
<p>
Here we installed all necessary files required to run and install the OsTicket software. Those files that we needed were the PHP Mananger, CGI, and 
the URL Rewrite files.
</p>
<br />
